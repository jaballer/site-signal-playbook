...
blocks:
  - type: thesis
    mark: →
    title: Every offer ends in a decision made on evidence.
    text: The client commits to the next step, not to a year. The audit ends with the findings and what fixing them is worth, the program with results against the targets set in its first month, and every retainer quarter with a review. Nobody is asked to fund the next stage on trust.
  - type: collection
    collection: offers
    heading: Offers
  ...
  - type: strip
    ...
    items:
      - title: Measurement fixes
        text: Immediately. Numbers the client can trust come first.
      - title: Crawl and indexing fixes
        text: Days to weeks, once the change ships and the pages are recrawled.
