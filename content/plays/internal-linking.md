...
steps:
  ...
  - Link every cluster page to its pillar and product page
  - Fix orphaned priority pages
moves:
  - internal-links
  - priority-rankings
watchOut: Sitewide footer links add little. Contextual links from relevant content do the work.
---
